  ...
  >
    <div className="relative group ml-14">
      ...
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-[#5c5ecf] to-[#eceaee] text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
...
const MainTitle = memo(() => (
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600" >
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight ml-6">
...
const TechStack = memo(({ tech }) => (
  <div className="px-4 py-2 hidden sm:block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors ml-3">
    {tech}
  </div>
));
...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[200px] ml-6"> {/* <-- Shift to right */}
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-3 ml-14">
...
const WORDS = ["Blockchain and CyberSecurity Student", "Tech Enthusiast "];
const TECH_STACK = ["Kali-Linux", "ETHEREUM", "BUG-BOUNTY", "WEB3"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jeston10" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jeston-singh/" },
  { icon: Instagram, link: "https://www.instagram.com/_just_shut_da_fuk_up_/" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen ml-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  'Envision' 'Master' and 'Conquer' . 'Web3' and 'AI' is the near future. " Because, Together We Can " </p>
